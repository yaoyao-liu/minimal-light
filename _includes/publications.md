...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="author"><strong>Wu, Jie JW</strong></div>
    <div class="periodical"><em> 3rd International Conference on AI Engineering – Software Engineering for AI (CAIN 2024) (long paper) <span style="color:red;">Distinguished Paper Award Candidate. Selected to appear in [IEEE Software](https://www.computer.org/csdl/magazine/so) Practioners' Digest column. </span> </em></div>
   <div class="links">
